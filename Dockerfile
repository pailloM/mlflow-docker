...
ENV PORT 5051
ENV MLFLOW_SERVER_ALLOWED_HOSTS 127.0.0.1
ENV MLFLOW_SERVER_CORS_ALLOWED_ORIGINS 127.0.0.1
ENV MLFLOW_SERVER_X_FRAME_OPTIONS SAMEORIGIN
ENV MLFLOW_SERVER_DISABLE_SECURITY_MIDDLEWARE false
VOLUME /artifacts
